...
opkg install kmod-usb-net-cdc-ncm kmod-usb-wdm kmod-usb-net-cdc-mbim kmod-usb-net-huawei-cdc-ncm
opkg install kmod-usb-net-qmi-wwan
opkg install umbim uqmi
opkg install kmod-usb-serial-qualcomm
opkg install kmod-usb2-pci
opkg install kmod-usb-serial-cypress-m8
opkg install kmod-usbmon
