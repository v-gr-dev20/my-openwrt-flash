...
#	./openwrt/build_dir/target-mipsel_mips32_musl/openwrt-imagebuilder-brcm47xx-legacy.Linux-x86_64/packages
#	./openwrt/build_dir/target-mipsel_mips32_musl/root.orig-brcm47xx/etc/opkg/keys/7d39be47dd13cf04
$tarFile = 'target_dir/openwrt-mipsel_mips32-export-packages.tgz'
