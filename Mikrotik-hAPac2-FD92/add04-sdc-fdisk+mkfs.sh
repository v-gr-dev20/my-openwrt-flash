#!/bin/ash
# Скрипт форматирует /dev/sdc (все данные будут стерты!):
# /dev/sdc1  32M Linux swap
# /dev/sdc2  32M Linux swap
# /dev/sdc3   2G Linux filesystem
# /dev/sdc4 X.XG Linux filesystem
